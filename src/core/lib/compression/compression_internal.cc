...
GzipCompressionOptions::GzipCompressionOptions(): gzip_compression_level_(Z_DEFAULT_COMPRESSION) {}

GzipCompressionOptions GzipCompressionOptionsFromChannelArgs(
    const ChannelArgs& args) {
  GzipCompressionOptions options;
  options.set_compression_level(Clamp(
